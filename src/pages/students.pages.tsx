...
const columns: GridColDef[] = [
  ...
  { field: 'mobile_number', headerName: 'Mobile Number', width: 150, headerClassName: 'super-app-theme--header' },
  { field: 'email_id', headerName: 'Email ID', width: 150, headerClassName: 'super-app-theme--header' },
  { field: 'blood_group', headerName: 'Blood Group', width: 150, headerClassName: 'super-app-theme--header' },
];
const top100Films = [
      ...
      .then((data) => {
        ...
        for (let i = 0; i < data.data.length; i++) {
          ...
          const rowobj = { 
                            ...
                            mobile_number: element.phoneNumber,
